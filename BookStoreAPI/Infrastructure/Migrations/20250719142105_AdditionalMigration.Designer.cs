...
namespace BookStoreAPI.Infrastructure.Migrations
{
    ...
    [Migration("20250719142105_AdditionalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookStoreAPI.Domain.Entities.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("BookStoreAPI.Domain.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("BookStoreAPI.Domain.Entities.UserRole", b =>
                {
                    b.HasOne("BookStoreAPI.Domain.Entities.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookStoreAPI.Domain.Entities.User", "User")
                        .WithMany("UserRoles")
